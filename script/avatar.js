...
module.exports.run = async function({ api, event, args }) {
    try {
        ...
        const apiUrl = `https://deku-rest-apis.ooguy.com/canvas/avatarv2?id=${encodeURIComponent(id)}&bgtext=${encodeURIComponent(bgtext)}&signature=${encodeURIComponent(signature)}&color=${encodeURIComponent(color)}`;
